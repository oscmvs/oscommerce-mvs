...
////////////////////////////////////////////////////
// Patched 5/19/2008 ***** Added vendor handling and Fee per Box
//
...
//      $this->handling_fee = constant('MODULE_SHIPPING_UPSXML_RATES_HANDLING_' . $vendors_id);
    function handling_fee ($vendors_id='1') {
      ...
      $this->handling_fee = $handling + constant('MODULE_SHIPPING_UPSXML_RATES_HANDLING_' . $vendors_id);
...
// EOF Time In Transit
  ...
  END of doing things differently:                */
                    ...
                    $methods[] = array ('id' => $type, 'title' => $_type, 'cost' => ($this->handling_fee ($vendors_id) + $cost) ) ;
                }
            }
