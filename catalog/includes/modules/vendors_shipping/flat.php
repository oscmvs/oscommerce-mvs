...
*/
  ...
  class flat {
    ...
    function quote($method = '', $module = '', $vendors_id = '1') {
      global $HTTP_POST_VARS, $order, $total_count, $shipping_weight, $shipping_num_boxes;
    ...
    function keys($vendors_id) {
      return array (
        'MODULE_SHIPPING_FLAT_STATUS_' . $vendors_id,
        'MODULE_SHIPPING_FLAT_COST_' . $vendors_id,
        'MODULE_SHIPPING_FLAT_TAX_CLASS_' . $vendors_id,
        'MODULE_SHIPPING_FLAT_ZONE_' . $vendors_id,
        'MODULE_SHIPPING_FLAT_SORT_ORDER_' . $vendors_id
      );
    }
  }
