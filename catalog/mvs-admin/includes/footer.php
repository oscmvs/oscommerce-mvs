...
osCommerce provides no warranty and is redistributable under the <a href="http://www.fsf.org/licenses/gpl.txt" target="_blank">GNU General Public License</a>
  ...
  <tr>
    <td align="center" class="smallText"><a href="http://www.oscmvs.com/" target="_blank">Multiverdor System by osCMVS</a> | Powered by <a href="http://www.oscommerce.com" target="_blank">osCommerce</a></td>
  </tr>
</table>
