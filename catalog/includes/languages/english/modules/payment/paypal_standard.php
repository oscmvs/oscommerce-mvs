...
*/
  ...
  define('MODULE_PAYMENT_PAYPAL_STANDARD_TEXT_PUBLIC_TITLE', 'PayPal (including Credit and Debit Cards)<br><img src="images/icons/paypal_cc.gif" width="210" height="80" />');
