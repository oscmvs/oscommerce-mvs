  ...
  class ups {
    ...
    function quote($method = '', $module = '', $vendors_id = '1') {
      ...
      if ((is_array($upsQuote)) && (sizeof($upsQuote) > 0)) {
        ...
        $this->quotes = array (
          'module' => $this->title,
          'error' => MODULE_SHIPPING_ERROR_NO_QUOTE
        );
      }
    ...
    function keys($vendors_id = '1') {
      return array (
        'MODULE_SHIPPING_UPS_STATUS_' . $vendors_id,
        'MODULE_SHIPPING_UPS_PICKUP_' . $vendors_id,
        'MODULE_SHIPPING_UPS_PACKAGE_' . $vendors_id,
        'MODULE_SHIPPING_UPS_RES_' . $vendors_id,
        'MODULE_SHIPPING_UPS_HANDLING_' . $vendors_id,
        'MODULE_SHIPPING_UPS_TAX_CLASS_' . $vendors_id,
        'MODULE_SHIPPING_UPS_ZONE_' . $vendors_id,
        'MODULE_SHIPPING_UPS_SORT_ORDER_' . $vendors_id,
        'MODULE_SHIPPING_UPS_TYPES_' . $vendors_id
      );
    }
