...
/*
  ...
  CONTRIB is Store Pickup Shipping Module (http://www.oscommerce.
   com/community/contributions,164)
...
*/
  ...
  class spu {
    ...
    function keys($vendors_id) {
      return array (
        'MODULE_SHIPPING_SPU_STATUS_' . $vendors_id,
        'MODULE_SHIPPING_SPU_COST_' . $vendors_id,
        'MODULE_SHIPPING_SPU_TAX_CLASS_' . $vendors_id,
        'MODULE_SHIPPING_SPU_ZONE_' . $vendors_id,
        'MODULE_SHIPPING_SPU_SORT_ORDER_' . $vendors_id,
        'MODULE_SHIPPING_SPU_SHIP_TEXT_' . $vendors_id
      );
    }
  }
