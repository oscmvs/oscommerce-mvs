...
// MVS Shipping Estimator Start
  if ($cart->count_contents() > 0 && SHIP_ESTIMATOR_BUTTON_CART_BOX == 'true') {
    $info_box_contents[] = array ('align' => 'left','text' =>  '<tr><td align="left" valign="top" class="infoBoxContents"><a href="javascript:estimatorpopupWindow(\'' .  tep_href_link (FILENAME_SHIP_ESTIMATOR, '', 'SSL') . '\')">' . tep_image_button ('button_estimate_shipping.gif', IMAGE_BUTTON_SHIP_ESTIMATOR) . '</a></td></tr>');
  }
