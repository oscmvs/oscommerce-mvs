...
/*
  ...
  http://www.oscommerce.com/community/contributions,487/page,12
        ...
        if (isset ($uspsQuote['error'])) {
          ...
          */
          ...
          for ($i = 0; $i < $size; $i++) {
            ...
            if (in_array('Display transit time', explode(', ', constant('MODULE_SHIPPING_USPS_OPTIONS_' . $vendors_id))))
    ...
    function _getQuote($vendors_id) {
      ...
      if ($order->delivery['country']['id'] == /*SHIPPING_ORIGIN_COUNTRY*/
        ...
        while (list ($key, $value) = each($this->types)) {
          ...
          $vendors_data['vendors_zipcode'] . '</ZipOrigination>' .
      ...
      if ($order->delivery['country']['id'] == SHIPPING_ORIGIN_COUNTRY) {
            ...
            if ($transit) {
              switch ($service) {
                ...
                case 'PARCEL' :
                  ...
                  break;
                case 'FIRST CLASS' :
                  $time = '2 - 15 ' . MODULE_SHIPPING_USPS_TEXT_DAYS;
                  break;
                default :
                  $time = '3 - 9' . MODULE_SHIPPING_USPS_TEXT_DAYS;
                  break;
              }
              if ($time != '')
        ...
        if (ereg('<Error>', $response[0])) {
          ...
          // BOF: UPS USPS
          $allowed_types = array ();
          foreach (explode(", ", constant('MODULE_SHIPPING_USPS_TYPES_INTL_' . $vendors_id)) as $value)
