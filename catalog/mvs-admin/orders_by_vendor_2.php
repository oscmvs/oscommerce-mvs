...
// $vendors_array = array (array ('id' => '1',
  ...
  // echo $vendors['vendors_id'];
  // echo $vendors_array['id'];
?>
...
?>
				...
				echo tep_draw_form('status_report', FILENAME_ORDERS_VENDORS . '?&vendors_id=' .$vendors_id) . HEADING_TITLE_STATUS . ' '; echo tep_draw_pull_down_menu('status', $orders_statuses, '','onChange="this.form.submit()";');?>
                </form></td>
              </tr>
            </table>
          </tr>
