...
*/
  ...
  class indvship {
    ...
    function keys($vendors_id) {
      return array (
        'MODULE_SHIPPING_INDVSHIP_STATUS_' . $vendors_id,
        'MODULE_SHIPPING_INDVSHIP_HANDLING_' . $vendors_id,
        'MODULE_SHIPPING_INDVSHIP_TAX_CLASS_' . $vendors_id,
        'MODULE_SHIPPING_INDVSHIP_ZONE_' . $vendors_id,
        'MODULE_SHIPPING_INDVSHIP_SORT_ORDER_' . $vendors_id
      );
    }
  }
