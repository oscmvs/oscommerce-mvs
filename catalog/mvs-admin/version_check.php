...
*/
  ...
  $response = file_get_contents("http://www.oscmvs.com/version/");	
  if (!empty($response)) {
    $releases = explode("\n", $response);
  }
...
?>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td class="smallText"><?php echo TITLE_INSTALLED_VERSION . ' <strong>osCMVS v' . $current_version . '</strong>'; ?></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><div class="<?php echo $check_message['class']; ?>">
          <p class="smallText"><?php echo $check_message['message']; ?> <?php if ($check_message['class'] == 'secWarning') { echo VERSION_PRO_SUPPORT;} ?></p>
        </div></td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
...
?>
              <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
                <td class="dataTableContent"><?php echo '<a href="' . $version[2] . '" target="_blank">osCMVS v' . $version[0] . '</a>'; ?></td>
